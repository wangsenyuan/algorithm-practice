...
- The next line contains integer `k` ($0 \leq k \leq 13$) — the number of forbidden pairs of letters.
...
### ideas
1. just remove it greedily?
2. 如果ab出现了，假如保留了a，那么如果再遇到b，就要继续删除
3. 所以这时候，需要保留的是b, abababababa (它们在一组里面， 那么就保留多的那个就可以了)