...
First input line contains integers n (0 ≤ n ≤ 30000) and t (1 ≤ t ≤ 50000), where n is the number of ants in the colony and t is the number of queries. Each of the next t lines contains coordinates of a query junction: integers xi, yi (-10^9 ≤ xi, yi ≤ 10^9). Queries may coincide.
...
**Explanation:** The colony consists of one ant, so nothing happens at all.
...
**Explanation:** The colony consists of 6 ants. At the first minute 4 ants scatter from (0, 0) to the neighbouring junctions. After that the process stops.

### ideas
1. 考虑某个远处的点，在某个时间，它出现了4个ant
2. 然后下一个时刻，这4个ant都离开了（向4个方向）