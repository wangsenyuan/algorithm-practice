...
The first line contains a single positive integer $n$ ($1 \le n \le 10^5$) — the number of initial bouquets.

The second line contains a sequence of integers $a_1, a_2, \ldots, a_n$ ($1 \le a_i \le 10^6$) — the number of flowers in each of the initial bouquets.
