...
The second line of the query contains n integers d₁, d₂, …, dₙ (2 ≤ dᵢ ≤ 10⁶), where dᵢ is the i-th divisor of the guessed number. It is guaranteed that all values dᵢ are distinct.
