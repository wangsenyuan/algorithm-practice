You are given a strictly convex polygon with n vertices. It is guaranteed that no three points are collinear. You would like to take a maximum non-intersecting path on the polygon vertices that visits each point at most once.
...
The next n lines will contain two integers xi, yi (|xi|, |yi| ≤ 10^9), denoting the coordinates of the i-th vertex.
