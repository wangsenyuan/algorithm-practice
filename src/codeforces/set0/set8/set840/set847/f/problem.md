...
After the end of the voting the number of votes for each candidate is calculated. In the resulting table the candidates are ordered by the number of votes. In case of tie (equal number of votes) they are ordered by the time of the last vote given. The candidate with earlier last vote stands higher in the resulting table.
...
1. A candidate will be elected to the parliament regardless of votes of the remaining m - a citizens;
2. A candidate has chance to be elected to the parliament after all n citizens have voted;
3. A candidate has no chances to be elected to the parliament regardless of votes of the remaining m - a citizens.
