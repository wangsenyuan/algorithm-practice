...
On the i-th day the festival will show a movie of genre aᵢ. We know that a movie of each of k genres occurs in the festival programme at least once. In other words, each integer from 1 to k occurs in the sequence a₁, a₂, …, aₙ at least once.
...
The first line of the input contains two integers n and k (2 ≤ k ≤ n ≤ 10⁵), where n is the number of movies and k is the number of genres.

The second line of the input contains a sequence of n positive integers a₁, a₂, …, aₙ (1 ≤ aᵢ ≤ k), where aᵢ is the genre of the i-th movie. It is guaranteed that each number from 1 to k occurs at least once in this sequence.
