...
The first line of the input contains five space-separated integers n, A, cf, cm and m (1 ≤ n ≤ 100 000, 1 ≤ A ≤ 10^9, 0 ≤ cf, cm ≤ 1000, 0 ≤ m ≤ 10^15).
...
### ideas
1. 假设有x个满级的, 最小值是w， x * cf + w * cm
2. 递增x，在固定的x的情况下，应该尽量的使的w大
3. 为了使w更大，那么花费在满级上面应该尽可能少吗？
4. 