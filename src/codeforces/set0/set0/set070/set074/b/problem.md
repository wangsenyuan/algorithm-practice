...
### ideas
1. controller的状态是确定的（只需要根据时间，就可以确定在时刻i，她的状态，在哪个车厢，以及移动的方向）
2. 所以，只需要考虑stowaway 的状态
3. 在train移动的时候， stowaway可以移动在左右、或者呆在原位置
4. 在train静止的时候，stowaway可以穿越到任何车厢
5. 当controller向head移动的时候，stowaway如果可以，他应该移动到车尾；如果不可以，他应该尽快移动到车头
6. 反过来也一样