...
The $i$-th of the following $n$ lines contains two integers $x_i$ and $y_i$ ($|x|, |y| \le 10000$, $x^2 + y^2 > 0$) — the coordinates of the $i$-th vector. Vectors are numbered from $1$ to $n$ in order of appearing in the input. It is guaranteed that no two vectors in the input share the same direction (but they still can have opposite directions).
