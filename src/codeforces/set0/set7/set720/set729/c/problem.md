...
- **Normal mode**: 
  - Covers 1 kilometer in 2 minutes
  - Consumes 1 liter of fuel
- **Accelerated mode**: 
  - Covers 1 kilometer in 1 minute
  - Consumes 2 liters of fuel

The driving mode can be changed at any moment and any number of times.
...
Each of the next **n** lines contains two positive integers **ci** and **vi** (1 ≤ ci, vi ≤ 10^9) — the price of the i-th car and its fuel tank capacity.
...
In the first sample, Vasya can reach the cinema in time using the first or the third cars, but it would be cheaper to choose the first one. Its price is equal to 10, and the capacity of its fuel tank is 8. Then Vasya can drive to the first gas station in the accelerated mode in 3 minutes, spending 6 liters of fuel. After that he can fill the tank and cover 2 kilometers in the normal mode in 4 minutes, spending 2 liters of fuel. Finally, he drives in the accelerated mode covering the remaining 3 kilometers in 3 minutes and spending 6 liters of fuel.
