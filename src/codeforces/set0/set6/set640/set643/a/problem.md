...
The first line of the input contains a single integer $n$ ($1 \le n \le 5000$) — the number of balls.

The second line contains $n$ integers $t_1, t_2, ..., t_n$ ($1 \le t_i \le n$) where $t_i$ is the color of the $i$-th ball.
