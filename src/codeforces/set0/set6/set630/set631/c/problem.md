...
The second line contains n integers ai (|ai| ≤ $10^9$) — the initial report before it gets to the first manager.
...
### ideas
1. 考虑 r1 <= r2 =< r3 .... 那么1, 2, 其实不用操作，因为它的效果会被r3覆盖掉
2. 反过来 r1 > r2 > r3, 这样子才可以
3. 那么首先第一点，得到一个新的序列, r1 > r2 > r3 .... > rn
4. 然后就可以从后开始处理了