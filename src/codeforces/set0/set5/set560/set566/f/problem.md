# Maximum Clique in Divisibility Graph
...
The second line contains n distinct positive integers a1, a2, ..., an (1 ≤ ai ≤ 10⁶) — elements of subset A. The numbers in the line follow in the ascending order.
