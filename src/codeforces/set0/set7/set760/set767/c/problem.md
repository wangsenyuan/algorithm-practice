...
Then **n** lines follow. The i-th of them contain the information about the i-th lamp: the number lamp **ai** it is hanging on (and 0, if there is no such lamp), and its temperature **ti** (-100 ≤ ti ≤ 100). The lamps are numbered from 1 to n.
