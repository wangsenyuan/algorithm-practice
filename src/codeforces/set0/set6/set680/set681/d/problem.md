# Problem D - Family Gift Tradition
...
1. A = B
2. The man number A is the father of the man number B
3. There is a man number C, such that the man number A is his ancestor and the man number C is the father of the man number B
...
## ideas
1. 对于选定的list，除了要让每个人把礼物送出去，还必须送给他计划要送出的人
2. 那么所有人的a组成的list（去重后，按照一定顺序排列的），就应该是答案
3. 而且这个顺序必须是按照低层级到高层级排列，否则低层级（按照规则3）就无法得到礼物
4. 所以只是个验证的问题？