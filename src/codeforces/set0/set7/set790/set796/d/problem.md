...
In the first sample, if you shut down road 5, all cities can still reach a police station within d = 4 kilometers.
...
### ideas
1. 可以先去重，这样子，每个城市最多一个police station
2. 从有station的节点开始出发
3. 然后bfs，遇到一个节点，它已经被访问过了，那么就删掉这条边
4. 