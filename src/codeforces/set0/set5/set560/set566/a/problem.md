...
The last n lines contain the given pseudonyms. Each pseudonym is a non-empty word consisting of lowercase English letters. Some pseudonyms can be repeating.
...
2. 首先需要确定，贪心是不是一定最优的？
3. 直观感觉是的
4. 即使这个可以，似乎也很难去处理啊， 因为naive的实现是 n * m 的
5. 这里组成两棵树？