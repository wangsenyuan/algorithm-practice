# President Boosch and Law Signing
...
- The first line contains two integers n and k (2 ≤ n ≤ 2·10^5, 0 < 2k ≤ n) — the number of laws accepted by the parliament and the length of one segment in the law list, correspondingly
- The next line contains n integers x1, x2, ..., xn — the absurdity of each law (1 ≤ xi ≤ 10^9)

## Output

Print two integers a, b — the beginning of segments that mr. Boosch should choose. That means that the president signs laws with numbers from segments [a; a + k - 1] and [b; b + k - 1]. 

**Note:** If there are multiple solutions, print the one with the minimum number a. If there still are multiple solutions, print the one with the minimum b.
