...
$$d = \text{round}\left(100 \cdot \frac{m}{n}\right),$$

where $\text{round}(x) = \lfloor x + 0.5 \rfloor$ is a function which maps every real to the nearest integer.
...
The first line contains two positive integers $n$ and $k$ $(1 \leq n \leq 1000, 1 \leq k \leq 100)$ standing for the number of submissions and the number of testing processes respectively.

The second line contains $n$ positive integers $a_1, a_2, \ldots, a_n$ $(1 \leq a_i \leq 150)$, where $a_i$ is equal to the number of tests the $i$-th submission is to be run on.
