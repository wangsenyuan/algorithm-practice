...
The first line consists of a single integer $n$ ($1 \leq n \leq 10^6$) — the number of piles.

Each of the next $n$ lines contains an integer $s_i$ ($1 \leq s_i \leq 60$) — the number of stones in the $i$-th pile.
...
In the second case, the following moves are possible by Sam:
