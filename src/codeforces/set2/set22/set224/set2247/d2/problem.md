...
[Problem link](https://codeforces.com/problemset/problem/2247/D2)
...
This is the hard version of the problem. The only difference between the versions
is that in this version, `q` can be non-zero.
...
(`1 ≤ n ≤ 10^6`, `0 ≤ q ≤ 10^6`) — the length of the array `a` and the number
of updates.
