...
- `1 di ai` ($1 \leq d_i \leq n$, $1 \leq a_i \leq 10,000$), representing an update of $a_i$ orders on day $d_i$, or
- `2 pi` ($1 \leq p_i \leq n - k + 1$), representing a question: at the moment, how many orders could be filled if the factory decided to commence repairs on day $p_i$?
