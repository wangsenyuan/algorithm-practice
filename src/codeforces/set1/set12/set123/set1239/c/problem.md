...
The first line contains integers $n$ and $p$ $(1 \leq n \leq 10^5$, $1 \leq p \leq 10^9)$ — the number of people and the amount of time one person uses the tank.

The second line contains $n$ integers $t_1, t_2, \ldots, t_n$ $(0 \leq t_i \leq 10^9)$ — the moments when the corresponding passenger will go for the boiled water.
