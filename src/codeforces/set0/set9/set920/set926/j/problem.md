# Problem J: Connected Components of Black Segments
...
The i-th of the next n lines contains two integers li and ri (1 ≤ li < ri ≤ 10^9) — the coordinates of the left and the right ends of the i-th segment. The segments are listed in the order they are added on the white line.
