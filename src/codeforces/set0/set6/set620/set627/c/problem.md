...
Each of the next m lines contains two integers xi, pi (1 ≤ xi ≤ d - 1, 1 ≤ pi ≤ 10^6) — the position and cost of gas at the i-th gas station. It is guaranteed that the positions of the gas stations are distinct.
...
### ideas
1. 假设到了某个位置x的时候，用完了汽油，这时候再决定使用哪个加油站的油
2. 有一个问题，应该加多少的油？
3. 