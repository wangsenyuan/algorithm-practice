...
In the second example if s = 1, f = 3, t = 2, Misha would go on the route 1 → 2 → 3, and Grisha would go on the route 2 → 3 and would see the text at both stations.


### ideas
1. f 应该是离lcp(s, t)最远的那个地方